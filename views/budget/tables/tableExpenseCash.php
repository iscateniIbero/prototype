...
$transactionExpense = json_decode(transactionIncomeAndExpense('Expense'));
?>
<?php foreach ($transactionExpense->transaction as $key) {?>
<div class="row row-cols-3" style="font-size: 13px;">
    <div class="col" style="font-weight: bold;">
     <?php echo $key->name; ?>
    </div>
    <div class="col" style="text-align: right;">
      <span class="negative">$<?php echo number_format($key->value, 0, '.', '.');?></span>
    </div>
    <div class="col" style="text-align: right;">
